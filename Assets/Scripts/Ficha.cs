...
{
    public McQueen(IJugador prop, int vel, int enf) : base(prop, 4, 4) {}
...
{
    public CJ(IJugador prop, int vel, int enf) : base(prop, 2, 7) {}
...
{
    public Knuckles(IJugador prop, int vel, int enf) : base(prop, 3, 4) {}
